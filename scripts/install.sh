...
# Configuration
# The Sara fork — desktop stamps pin CI SHAs from THIS repo, not upstream.
REPO_URL_SSH="git@github.com:peopleworks-ai/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/peopleworks-ai/hermes-agent.git"
