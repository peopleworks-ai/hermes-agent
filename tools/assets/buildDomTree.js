/*
 * buildDomTree.js — vendored from browser-use (MIT license)
 * Source: https://raw.githubusercontent.com/browser-use/browser-use/0.2.6/browser_use/dom/buildDomTree.js
 * Tag: 0.2.6 (upstream removed this file in later versions — 0.13+ extracts
 * the DOM in Python over raw CDP instead).
 *
 * Used by tools/browser_tool.py :: browser_dom_snapshot — injected into the
 * page as a single expression and called with
 *   {doHighlightElements:false, focusHighlightIndex:-1, viewportExpansion}.
 * Returns {rootId, map} where map[id] = {tagName, attributes, xpath,
 * isVisible, isTopElement, isInteractive, highlightIndex?, children[]} and
 * text nodes are {type:'TEXT_NODE', text, isVisible}.
 *
 * Do not hand-edit — re-vendor from a pinned tag and update this header.
 */
(
  args = {
