...
_HERMES_CORE_TOOLS = [
    ...
    "browser_vision", "browser_dom_snapshot", "browser_dom_click",
    "browser_dom_type", "browser_dom_get_dropdown_options",
    "browser_dom_select_option", "browser_dom_scroll_to_text",
